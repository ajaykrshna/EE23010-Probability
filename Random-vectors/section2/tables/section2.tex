...
\ifthenelse{\isundefined{\gnumericColB}}{\newlength{\gnumericColB}}{}\settowidth{\gnumericColB}{\begin{tabular}{@{}p{120pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\myvec{ 3.5\\ -1.5 }}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\myvec{ 1.5\\ 1.0 }}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n2}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\myvec{ 2.0\\ -1.33 }}}
	&\multicolumn{1}{p{\gnumericColC}|}%
